...
jQuery(function($) {
    ...
    $( document ).on( 'change', 'select#pa_color', function() {
        if($(this).val() == 'black') {
            $('.tm-product-gallery-img a').attr('href', 'images/products/prod-img4.html');
            $('.tm-product-gallery-img img').attr('src', 'images/products/prod-img4.html');
        } else {
            $('.tm-product-gallery-img a').attr('href', 'images/products/prod-img2.html');
            $('.tm-product-gallery-img img').attr('src', 'images/products/prod-img2.html');
        }
    ...
    $('.tm-contact-form form').on('submit', function(e){
        ...
        $.post('sendmail.html', form.serialize(), function (result)
        {
            setTimeout(function() {
